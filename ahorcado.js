...
let palabrasAhorcado = ["java","agua","cielo","perro","gato","robot","ciencia","plataforma","pirata","hacker","malware","script","html","xbox","windows","alura","odin","oracle","react","visual","programacion","python","frontend","backend","intel","ahorcado","security"];//arreglo con palabras iniciales
//elementos del html
...
function btnGuardarReemplazar(){ // se crea u boton al momento de seleccionar la opcion agregar palabra
    ...
    if(screen.width <= 1385 && screen.width >= 1024 ){
        body.style.backgroundColor="grey"; /* en esta linea se cambia el color de fondo de la segunda pantalla*/
        guardarRemplazarbtn.style.top ="75%";
...
function inputFrase(){
    ...
    inputFrases.style.fontSize ="20px"; /*en esta linea cambiamos el tamanio de la letra del texto del input text de la segunda pantalla*/
